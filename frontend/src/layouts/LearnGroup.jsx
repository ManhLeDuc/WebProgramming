...
class LearnGroup extends Component {
  ...
  wordLeft = () => {
    return (
      this.state.originalWords.length - (this.state.wrong + this.state.right)
    );
  };
          ...
          <div className="row">
            <div className="col-3">
              <List component="nav">
                ...
                <ListItem>
                  <ListItemText
                    primary={this.state.wrong + "/" + this.state.right}
                  />
                </ListItem>
                <ListItem>
                ...
                <ListItem
                  button
                  onClick={() => {
                    window.location.href = `/wordGroups/${this.props.match.params.wordGroupId}`;
                  }}
                >
