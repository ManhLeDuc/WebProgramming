  ...
  (e) => {
    if (e) {
      ...
      myInterface = readline.createInterface({
        input: fs.createReadStream(`${__dirname}/anhviet109K.txt`),
      });
        ...
        try {
          if (line.startsWith("@")) {
            ...
            if (flag == 0) {
              ...
              trueWord["datas"][wordDataCount - 1]["meanings"].push({
                ...meaning,
              });
            } else if (flag == 1) {
              ...
              trueWord["collocations"][collocationCount - 1]["meanings"].push({
                ...meaning,
              });
            }
            meaningCount += 1;
            ...
            if (flag == 0) {
              trueWord["datas"][wordDataCount - 1]["meanings"][
                meaningCount - 1
              ]["examples"].push({ ...example });
            } else if (flag == 1) {
              trueWord["collocations"][collocationCount - 1]["meanings"][
                meaningCount - 1
              ]["examples"].push({ ...example });
            }
            exampleCount += 1;
